...
class _GoogleSignAppState extends State<GoogleSignApp> {
  ...
  Future<FirebaseUser> _signIn(BuildContext context) async {
    ...
    print(userDetails.providerId);
    print(userDetails.displayName);
    print(userDetails.email);
    Navigator.push(
      context,
      new MaterialPageRoute(
        builder: (context) => new home_screen(detailsUser: details),
      ),
    );
    return userDetails;
  }
                    ...
                    child: Align(
                      ...
                      child: RaisedButton(
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Icon(FontAwesomeIcons.google,color: Colors.cyan),
                            SizedBox(width:10.0),
                            Text(
                              'Sign in with Google',
